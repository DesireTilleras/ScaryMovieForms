    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Desire", "Tillerås", "0700000001" },
                    { 2, "Tintin", "Petersson", "0700000002" },
                    { 3, "Amanda", "Eriksson", "0700000003" },
                    { 4, "Jonathan", "Kullman", "0700000004" },
                    { 5, "Jesper", "Hultén", "0700000005" },
                    { 6, "Eva-Marie", "Tillerås", "0700000006" },
                    { 7, "Linda", "Johansson", "0700000007" },
                    { 8, "Alma", "Ragnarsson", "0700000008" },
                    { 9, "Emmiline", "Larsson", "0700000009" },
                    { 10, "Madeleine", "Ivarsson", "0700000010" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 3, 3, "2021-06-18 24:00" },
                    { 1, 1, "2021-06-18 20:00" },
                    { 2, 2, "2021-06-18 22:00" },
                    { 4, 4, "2021-06-17 02:00" }
                });
